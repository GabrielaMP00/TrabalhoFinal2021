...
public class TelaGerenciarPaciente extends JPanel {
	...
	public boolean verificar(){
		if(this.getFieldNomePaciente().getText().equals("") || this.getFormatedFieldCPF().getText().equals("")|| this.comboBox.getSelectedItem().equals(null) || this.getFieldNomeDaMae().getText().equals("") ||
				this.getFieldNomedoPai().getText().equals("") 
				)
		{
			return false;
		}
